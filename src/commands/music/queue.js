...
export default class QueueCommand extends Command {
    ...
    */
    ...
    async run(message, args, player) {
        ...
        .setDescription(`**Tocando agora:** \`${player.queueIndex + 1}\`. [\`${player.queue[player.queueIndex].title}\`](${player.queue[player.queueIndex].url}), **${player.queue[player.queueIndex].author}**\n\n${des.join("\n")}`)
